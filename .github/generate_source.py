...
def main() -> None:
    ...
    version_entry = {
        ...
        "buildVersion": build,
        "date": now,
        "localizedDescription": "NContainer SideStore内蔵版。NContainerのBeta機能を含む最新ビルドです。",
        "downloadURL": ipa_url,
        "size": size,
    }
    source = {
        ...
        "apps": [{
            ...
            "subtitle": "LiveContainerベースのNContainer",
            "version": version,
            "versionDate": now,
            "versionDescription": "NContainer SideStore内蔵版",
            "downloadURL": ipa_url,
            "localizedDescription": "NContainerのSideStore内蔵版",
            "iconURL": f"https://raw.githubusercontent.com/{repository}/main/screenshots/livecontainer_icon.png",
            "size": size,
